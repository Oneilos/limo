...
Mobi.openPopup = function( id ) {
    ...
    Jaf.log('Mobi.openPopup.ouverte='+Mobi.openPopup.ouverte);
...
Mobi.initAffichage = function() {
    if ( Mobi.initAffichage.loaded ) {
        return '';
    } 
    Mobi.initAffichage.loaded = true;
...
Mobi.debuggage = function () {
    ...
    var trans = $.ajax({
        url      : Jaf.urlSite+'mobilimo/debuggage',
        type     : 'POST',
        dataType : 'jsonp',
        data     : datas,
        cache    : false
