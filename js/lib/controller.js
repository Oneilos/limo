var JafController = function () {
    ...
    JafController.prototype.loadData = function () {
    ...
    JafController.prototype.run = function () {
        ...
        Jaf.cm.saveDataLocal(this.databases);
    }
    ...
    JafController.prototype.changeStatus = function() {
        Jaf.log('statut_old='+this.status_old+',statut='+this.status);
    ...
    JafController.prototype.execute = function() {
        ...
        switch ( this.status ) {
            case 1 : this.initAffichage();   break;
            ...
            case 7 :  return false; this.initEvents();      break;
