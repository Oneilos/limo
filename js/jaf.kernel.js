var Jaf = {
    ...
    maps : {
        ...
        loadMapItineraireNew : function (idmap,etapes,idpanel,macallbackfonction) {
        ...
        if (monHtml) {
            ...
            if ( le && le.length > 0 ) {
                ...
                for(var i in lc ) {
                    ...
                    if (  dico[ cle ] || Jaf.dico[ LAN_CODE_DEFAULT ][ cle ] )  {
	...
	formatValue : {
        ...
        Temps   : function ( value ) {
            if ( typeof value=='string' ) {
                ...
                var minutes = Math.round( ( value - hours*3600 ) / 60 );
            }
            if ( formatHeure && formatHeure == 'anglais') {
                return sprintf( '%02d:%02d' , hours , minutes ) ;
            } else {
        ...
        Km : function (value) {
            return sprintf('%0.1f', ( metricLocale == 'mi' ? 0.62137 * value : value ) ) + ' ' + metricLocale;
        }
	},
